...
const Hero = () => {
    ...
    return (
        <section
            ref={ref}
            id="hero"
            className=" mb-8 hero flex gap-5 w-full md:h-[90vh] flex-col-reverse pt-16 md:pt-0 justify-center items-center text-center sm:mb-0 md:flex-row scroll-mt-[100rem]"
        >
            <div className="flex w-full text-[12px] justify-center items-center flex-col md:text-start md:w-[50%] lg:w-[50%]">
                ...
                <motion.h1
                    className="mb-8 sm:mb-10 w-full px-3 sm:px-0 mt-4 text-2xl font-medium !leading-[1.5] lg:text-4xl"
                    initial={{ opacity: 0, y: 100 }}
                    animate={{ opacity: 1, y: 0 }}
                >
                    ...
                    <br />
                    <span className="mt-3 sm:mt-0 block">
                        <span className="font-[500] text-[18px] sm:text-[30px]">I&apos;m not the </span>
                        <span className="italic font-[600] md:text-gray-950 text-[18px] sm:text-[32px]">best,</span>{" "}
                        <span className="font-[500] text-[18px] sm:text-[30px]">But I really do my </span>
                        <span className="sm:text-[32px] text-[18px]">best.</span>
                    </span>
                </motion.h1>
                ...
                >
                    <div className="wrapper">
                        <a href="/CV.pdf" download className="button">
                            <div className="icon  dark:text-gray-300  flex text-gray-950 justify-center items-center">
                                <HiDownload />
                            </div>
                            <span className="ml-2  dark:text-gray-300 text-nowrap text-gray-950">
                                Download CV
                            </span>
                        </a>
                    </div>
                    <div className="wrapper">
                        <a href="#contact"
                        className="button">
                            <div className="icon text-gray-950 dark:text-gray-300 flex justify-center items-center">
                                <GrContactInfo />
                            </div>
