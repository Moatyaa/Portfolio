...
function Experiences() {
    ...
    return <>
        ...
        >
            <motion.section
                ref={ref}
                className='text-center  mb-16 sm:mb-24 scroll-mt-48 mx-auto w-full sm:w-[90%] md:w-[80%] lg:w-[70%]'
                id="experience"
            ...
            >
                ...
                <VerticalTimeline lineColor='' className='!pt-[0]'>
                    {experiencesData.map((job, index) =>
                        <VerticalTimelineElement
                            key={index}
                            contentStyle={{
                                background: mode === 'dark' ? "rgba(255,255,255, 0.05)" : "#f3f4f6",
                            ...
                            contentArrowStyle={{
                                borderRight: mode === "dark" ? "0.4rem solid rgba(255,255,255,0.5)" : "0.4rem solid #9ca3af"
                            }}
                            date={job.date}
                            icon={job.icon}
                            iconStyle={{
                                background: mode === "dark" ? "rgba(255,255,255,0.15)" : "white",
                                fontSize: "12px",
                                marginTop: '5px',
                        ...
                        >
                            <div>
                                <h3 className="font-semibold text-[15px] text-gray-800 dark:text-gray-200  capitalize">{job.title}</h3>
