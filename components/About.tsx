...
function About() {
    ...
    return <>
        ...
        >
            <motion.section
                ref={ref}
                className="mb-16 sm:mb-24 w-[95%] scroll-mt-28 pt-5 lg:w-[50%] md:pt-8 ms-auto leading-9"
                id="about"
            ...
            >
                ...
                >
                    ...
                    techniques to improve my skills. Enjoy optimizing performance, and making
